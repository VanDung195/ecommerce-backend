...
router.get('/spu/:spuId', checkShopPermission, grantAccess('readOwn', 'product'), asyncHandler(ProductController.getOneSpuDetail));
...
router.get('/spu/shop/all', checkShopPermission, grantAccess('readOwn', 'product'), asyncHandler(ProductController.getALlProductByShop))
